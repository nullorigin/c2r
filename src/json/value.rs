...
impl Value {
    ...
    /// ```
    pub fn members(&self) -> iterators::Members<'_> {
        match *self {
    ...
    /// Will return an empty iterator if called on non-array types.
    pub fn members_mut(&mut self) -> iterators::MembersMut<'_> {
        match *self {
        ...
        T: Into<Value>,
    {
        match *self {
            ...
            _ => Err(C2RError::new(
                ...
                Some("Not an object, cannot insert".to_string()),
            )),
        }
    }
